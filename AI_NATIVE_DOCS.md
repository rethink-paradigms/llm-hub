...
2. ✅ **Documentation folder**: `.aimanifest/README.md` for usage guide
3. 🔄 **PyPI packages**: TODO - Include in package data
4. 🔄 **HTTP endpoint**: TODO - Publish at predictable URL
...
```
llmhub.aimanifest.yaml              # Main manifest (1,123 lines)
.aimanifest/README.md               # Usage documentation (167 lines)
