...
def test_spec_schema_components():
    ...
    from llmhub_cli.generator.spec import parse_project_spec
    ...
    from llmhub_cli.generator.selection import select_for_role, SelectorOptions
    from llmhub_cli.generator.emitter import build_machine_config
